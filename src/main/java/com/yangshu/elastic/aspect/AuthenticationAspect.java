...
import com.yangshu.elastic.annotation.UserAuthentication;
import com.yangshu.elastic.constant.RedisConstant;
...
public class AuthenticationAspect {
    ...
    @Pointcut(value = "@annotation(com.yangshu.elastic.annotation.UserAuthentication)")
     ...
     */
    @AfterReturning(returning = "result", value = "@annotation(com.yangshu.elastic.annotation.UserAuthentication)")
